            ...
            <div class='form-group  col-sm-12' >
                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group  text-left col-sm-6">
                        ...
                        <div class="clearfix"></div>
                       <!--  <div contentEditable="true" class="editable-area" id="msg-desc-div">{!! $campaign->body !!}</div>
                        <input name="msg-desc" id="msg-desc" type="hidden"/> -->
                        <textarea type="wysiwyg" name="msg-desc" id="msg-desc">{!! $campaign->body !!}</textarea>
                    </div>
                   <div class="col-sm-6">
                   ...
                   <div class="clearfix"></div>
                    <div class="col-sm-8 text-left"><strong>&lt;first_name&gt;</strong> will be replaced with your friend's first name or will be "friend" when the info is not available.</span>
                        ...
                        <div class="form-group text-left col-sm-8">
                            ...
                            <!--<a href="{{ Request::root().'/saveMsg'}}"  title="click this button to save your msg"></a>-->
                        </div>
                </form>
